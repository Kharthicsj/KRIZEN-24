        ...
        <div className="mainContent">
          ...
          <div className="title">
            ...
            <div className="main_links">
              <a
                className="register"
                href="https://docs.google.com/forms/d/e/1FAIpQLSdN7ZbmMjthY6ScqB0LpeAQHf1xktEDJtwchx33hdMcFAiodQ/viewform?usp=pp_url"
              >
                Register
              </a>
              ...
              <div className="rounds">
                <div className="roundsContent">
                  <p>
                    ...
                    Each participant will draw a set of words randomly, which
                    they must incorporate into their stories, fostering a spirit
                    of improvisation and quick thinking.
                  </p>
                  <br />
                  <p>
                    The challenge will not only test their storytelling
                    abilities but also encourage them to think on their feet and
                    adapt their ideas in real-time. Participants will be judged
                    on creativity, coherence, and engagement, making this a
                    dynamic and exciting event that celebrates the art of
                    storytelling in a collaborative environment.
                  </p>
                </div>
                <h3 className="roundsTitle">WhtasApp Group Link</h3>
                <div className="roundsContent">
                    <a href="https://chat.whatsapp.com/K24kNyOeUR38GmzHuBgtTY">https://chat.whatsapp.com/K24kNyOeUR38GmzHuBgtTY</a>
                </div>
